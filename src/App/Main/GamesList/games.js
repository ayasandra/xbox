const games = [ 
   {
      ...
      category: "Shooter",
      image: "https://github.com/ayasandra/xbox/blob/master/img/callofdutycard.jpg?raw=true",
      ...
      picture: "https://github.com/ayasandra/xbox/blob/master/img/img-games/pic1.jpg?raw=true",
...

   {
      ...
      type: "Multiplayer",
      category: "Shooter",
      image: "https://github.com/ayasandra/xbox/blob/master/img/destiny-card.jpg?raw=true",
      description: <div className='game-page'>
      ...
      picture: 'https://github.com/ayasandra/xbox/blob/master/img/img-games/destiny2-newlight.jpg?raw=true',
...

   {
      ...
      type: "Single player/Multiplayer",
      category: "Sports",
      image: "https://github.com/ayasandra/xbox/blob/master/img/steep-card.jpg?raw=true",
      description: <div className='game-page'>
      ...
      picture: 'https://github.com/ayasandra/xbox/blob/master/img/img-games/steep.jpg?raw=true'
   },

   {
      ...
      type: "Single player/Multiplayer",
      category: "Racing",
      image: "https://github.com/ayasandra/xbox/blob/master/img/motosport-card.jpg?raw=true",
      description: <div className='game-page'>
      ...
      picture: 'https://github.com/ayasandra/xbox/blob/master/img/img-games/motorsport7.jpg?raw=true'
   },

   {
      ...
      category: "Shooter",
      image: "https://github.com/ayasandra/xbox/blob/master/img/starwar-card.jpg?raw=true",
      description: <div className='game-page'>
      ...
      picture: 'https://github.com/ayasandra/xbox/blob/master/img/img-games/starwars2.jpg?raw=true'
   },
   
   {
      ...
      type: "Single-player/Multiplayer",
      image: "https://github.com/ayasandra/xbox/blob/master/img/gta5-card.jpg?raw=true",
      description: <div className='game-page'>
      ...
      picture: 'https://github.com/ayasandra/xbox/blob/master/img/img-games/GTAV.jpg?raw=true'
   },
